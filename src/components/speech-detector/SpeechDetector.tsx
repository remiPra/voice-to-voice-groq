...
const SpeechDetector: React.FC<SpeechDetectorProps> = ({
  ...
  //     formData1.append("voice_file", file); // ✅ Envoyer en tant que FICHIER

  //     // const response = await fetch("http://localhost:8020/synthesize/", {
  //     //   method: "POST",
  //     //   body: formData1,
  //     // });
  //     const formData = new FormData();
  //     formData.append("text", text);
  //     formData.append("voice", "macron"); // Change la voix si besoin
  //     formData.append("speed", "1.0"); // Ajuste la vitesse

  //     const response = await fetch(
  //       "https://b5ec-213-173-109-30.ngrok-free.app/synthesize/",
  //       {
  //         method: "POST",
  //         body: formData,
  //       }
